...
charDoubleIntDouble = Struct4 1 0.1 63 :: Struct4 CChar Double CInt Double
doubleDoubleDoubleDouble = Struct3 0.1 0.1 0.1 0.1 :: Struct3 Doule Double Double Double
intIntIntInt = Struct3 636363 636363 636363 636363 :: Struct3 CInt CInt CInt CInt
charCharCharChar = Struct3 1 1 1 1 :: Struct3 CChar CChar CChar CChar

sizeOfStruct4 = testGroupe "sizeOfStruct4" [
    ...
    , testCase "charDoubleIntDouble" $ 36 @=? sizeOf charDoubleIntDouble
    , testCase "doubleDoubleDoubleDouble" $ 36 @=? sizeOf doubleDoubleDoubleDouble
